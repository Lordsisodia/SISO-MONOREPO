    ...
    <div className="min-h-screen bg-[#05060C] text-white">
      <div className="mx-auto max-w-6xl space-y-6 p-4 lg:p-8">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 animate-pulse">
          ...
          <div className="mt-4 h-8 w-3/4 rounded-full bg-white/20" />
          <div className="mt-3 h-4 w-1/3 rounded-full bg-white/10" />
        </div>
        <div className="grid gap-5 lg:grid-cols-3">
          {[0, 1, 2].map((index) => (
            <div key={index} className="rounded-3xl border border-white/10 bg-white/3 p-5 animate-pulse">
        ...
        <div className="space-y-4 rounded-3xl border border-white/10 bg-white/5 p-6 animate-pulse">
          {[0, 1, 2, 3].map((index) => (

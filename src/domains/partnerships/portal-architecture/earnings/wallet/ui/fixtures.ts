  ...
  insights: [
    {
      ...
      type: "spending",
      impact: "medium",
      actions: ["Review stack", "Consolidate tools"],
...
export const walletSecuritySnapshot: WalletSecurity = {
  biometricAuth: {
    ...
    setupComplete: true,
    methods: [
      { type: "face_id", enabled: true, name: "iPhone Face ID", deviceFingerprint: "ios-13-pro" },
      { type: "fingerprint", enabled: false, name: "Studio Laptop", deviceFingerprint: "win-hello" },
    ],
  },
  transactionLimits: {
  ...
  trustedDevices: [
    { id: "device-1", name: "iPhone 15 Pro", type: "mobile", deviceFingerprint: "ios-15-pro", lastUsed: new Date("2025-11-08T22:11:00Z") },
    { id: "device-2", name: "MacBook Studio", type: "desktop", deviceFingerprint: "mac-studio", lastUsed: new Date("2025-11-07T17:33:00Z") },
  ],
  loginSessions: [],
  securityScore: 82,

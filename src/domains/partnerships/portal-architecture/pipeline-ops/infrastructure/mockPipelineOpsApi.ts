...
const mockProspects: ProspectSummary[] = [
  ...
  },
  {
    ...
    contactName: "Kara Singh",
    contactEmail: "kara@lumencommerce.com",
    nextAction: "Share onboarding toolkit",
    confidence: 0.55,
    stage: "qualified",
    status: "onboarded",
    owner: "Morgan (SISO)",
    tags: ["marketplace", "ops"],
    updatedAt: "2025-11-06T18:45:00Z",
  },
  {
    id: "prospect_greenfield",
    company: "Greenfield Analytics",
    contactName: "Leo Anders",
    contactEmail: "leo@greenfield.ai",
    nextAction: "Prep completion summary",
    confidence: 0.81,
    stage: "qualified",
    status: "complete",
    owner: "Sasha (SISO)",
